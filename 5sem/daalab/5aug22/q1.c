...
t = clock();
insertionSort(arr1,n,0); //count seconds for sorting already ascending sorteddata;
t = clock() - t;
...
8. Time Complexity to sort ascending of data for all Cases\n(Data in Ascending, Data in Descending & Random Data) in a table for values n=5000 to 50000,step=5000\n");
